...
\begin{document}
    ...
    \chapter{Resortes y Mecanismos Neumáticos}
        ...
        \paragraph{Sujección de pieza} 

        Se pide un circuito neumático que sujete una pieza durante 10 segundos al pulsar un pulsador de inicio de operación. Posteriormente, debe retroceder aunque el pulsador esté pulsado.
